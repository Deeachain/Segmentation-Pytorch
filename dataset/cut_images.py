...
# output_dir = "/media/ding/Data/datasets/paris/512_image_625/no_crop_files"  # 裁剪好的小图目录
#
...
#
#                 crop_image.save(output_dir + '/{}_image/{}_{}_{}.png'.format(cropsize, image_name, j, i))
#                 crop_label.save(output_dir + '/{}_label/{}_{}_{}.png'.format(cropsize, image_name, j, i))
#
#
