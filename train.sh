...
# large model
#python train.py --max_epochs 100 --batch_size 4 --model UNet --dataset paris --optim sgd --lr 0.001
python train.py --max_epochs 100 --batch_size 4 --model PSPNet50 --dataset paris --optim adam --lr 0.001